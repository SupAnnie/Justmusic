...
class PAINO():
    def __init__(self):
        ...
        # img = pygame.image.load("piano_img.png")
        # self.piano_img = pygame.transform.scale(img, (1200, 600))
    def get_point(self):
        points = []
        points1 = []
        points2 = []
    ...
    def draw(self, screen, play_mode):
        # screen.blit(self.piano_img, (0, 0))
        # for i in range(2):
        #     pygame.draw.polygon(screen, (255, 255, 255), (self.points[0][n], self.points[1][n], ))
        for n in range(self.num_key_w * self.NUM_key+1):
        ...
        pygame.draw.line(screen, (0, 0, 0), (-self.angle*600+600, 600-self.angle*self.key_h-self.h), (self.angle*600+593, 600-self.angle*self.key_h-self.h), width=1)
        pygame.draw.line(screen, (0, 0, 0), (-self.angle*600+600, 600-2*self.angle*self.key_h-2*self.h-self.h2), (self.angle*600+593, 600-2*self.angle*self.key_h-2*self.h-self.h2), width=1)
        pygame.draw.line(screen, (0, 0, 0), (0, 600-self.angle*self.key_h-2*self.h-self.h2), (1190, 600-self.angle*self.key_h -2*self.h-self.h2), width=1)
        pygame.draw.line(screen, (0, 0, 0), (0, 600-self.angle*self.key_h-self.h-self.h2), (1190, 600-self.angle*self.key_h-self.h-self.h2), width=1)
        pygame.draw.line(screen, (0, 0, 0), (0, 600-self.h), (1190, 600-self.h), width=1)
